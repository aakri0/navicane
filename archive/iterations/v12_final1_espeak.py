...
logging.basicConfig(
    filename='/home/pi/interdesciplinary/blind_stick.log',
    level=logging.INFO,
...
def main():
    ...
    print("\n" + "="*60)
    print("🦯 SMART BLIND STICK SYSTEM - OFFLINE MODE (HEADLESS)")
    print("="*60)
    ...
    print("="*60)
    print("System Status: RUNNING (HEADLESS MODE)")
    print("Create /tmp/stop_blind_stick file to stop gracefully")
    print("="*60)
    
    logging.info("Main system loop starting - HEADLESS MODE")
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # For headless operation, comment out display-related lines
            ...
            # For headless operation, use time delay instead of cv2.waitKey
            # if cv2.waitKey(1) & 0xFF == ord('q'):
            #     break
            time.sleep(0.05)  # Small delay for headless operation
